...
<head>
	...
	<title>Welcome to VIT managment system</title>
...
<body>
	...
	<div class="img_home_pos">
		<a href="#"></a><span class="header_pos">VIT University</span>
	</div><br>

	<div class="dropdownmenu_container">
		<?php
		include './drop_down_menufaculty.php';
		?>
	</div>
	...
	<div class="container_middle">
		...
		<div class="container_show_post">
			...
			elseif ($tag = "leaveFaculty")
				include("leaveFaculty.php");
			/*$tag= $_REQUEST['tag'];

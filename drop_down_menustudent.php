...
<div class="btn-group">
	...
	<ul class="dropdown-menu" role="menu">
		...
		<li><a href="view_student.php?tag=view_students">View Students</a></li>
	</ul>
</div>
...
<div class="btn-group">
	...
	<ul class="dropdown-menu" role="menu">
		...
		<li><a href="view_student.php?tag=view_faculties">View Facility</a></li>
	</ul>
</div>
...
<div class="btn-group">
	...
	<ul class="dropdown-menu" role="menu">
		...
		<li><a href="view_student.php?tag=view_subjects">View Subjects</a></li>
	</ul>
</div>
...
<div class="btn-group">
	...
	<ul class="dropdown-menu" role="menu">
		...
		<li><a href="view_student.php?tag=view_scores">View Score</a></li>
	</ul>
</div>
...
<div class="btn-group">
	<button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-star-empty"></span>
		Leave Request <span class="caret"></span>
	</button>
	<ul class="dropdown-menu" role="menu">

		<li><a href="leaveStudent.php">Leave Request</a></li>
	</ul>
</div>